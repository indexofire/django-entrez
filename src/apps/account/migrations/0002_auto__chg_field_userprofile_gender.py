...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'account_userprofile', 'gender', self.gf('django.db.models.fields.PositiveSmallIntegerField')(max_length=1))

    def backwards(self, orm):

        # Changing field 'UserProfile.gender'
        db.alter_column(u'account_userprofile', 'gender', self.gf('django.db.models.fields.CharField')(max_length=1))
