...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'EntrezTerm.term'
        db.alter_column(u'entrez_entrezterm', 'term', self.gf('django.db.models.fields.TextField')())

    def backwards(self, orm):

        # Changing field 'EntrezTerm.term'
        db.alter_column(u'entrez_entrezterm', 'term', self.gf('django.db.models.fields.CharField')(max_length=512))
