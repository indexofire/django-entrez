...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'favor_favorite', (
        ...
        db.send_create_signal(u'favor', ['Favorite'])

        # Adding unique constraint on 'Favorite', fields ['user', 'content_type', 'object_id']
        db.create_unique(u'favor_favorite', ['user_id', 'content_type_id', 'object_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'Favorite', fields ['user', 'content_type', 'object_id']
        db.delete_unique(u'favor_favorite', ['user_id', 'content_type_id', 'object_id'])

        # Deleting model 'Favorite'
        db.delete_table(u'favor_favorite')
